...
class ConsultaController extends AbstractController
{
    ...
    public function index(Request $request, ManagerRegistry $doctrine): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $academico = $doctrine->getRepository(Consulta::class)->findOneBy(['email' => $data['email']]);
            ...
            if (!$academico) {
                ...
                $token = $academico->getToken();
                    ...
                    $urlVoto = "https://dev.matmor.unam.mx/consulta/voto/" . $academico->getToken();
    ...
    public function voto(Request $request, ManagerRegistry $doctrine, Consulta $consulta): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $data = $form->getData();
            $consulta->setVoto($data["category"]);

            $dateNow = new \DateTime("now");
            $consulta->setFecha($dateNow);
